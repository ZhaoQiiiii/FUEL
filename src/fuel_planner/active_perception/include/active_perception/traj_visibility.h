...
class VisibilityUtil {
  ...
  public:
    ...
    vector<Eigen::Vector3d> precomputeForVisibility(const vector<Eigen::Vector3d> &ctrl_pts, bool debug = false);
  ...
  private:
    Eigen::Vector3d getMinDistVoxel(const Eigen::Vector3d &q1, const Eigen::Vector3d &q2, const Eigen::Vector3d &offset,
                                    const double &res);
